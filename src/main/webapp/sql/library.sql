...
/*Table structure for table `bookcommit` */

DROP TABLE IF EXISTS `bookcommit`;
...
/*Data for the table `bookcommit` */

insert  into `bookcommit`(`id`,`bookid`,`commit`) values 
(1,1,'真不错'),
(2,1,'这书确实不错'),
(3,1,'我喜欢'),
(4,1,'太强了'),
...
(138,123,2,'2021-05-30 17:14:56','2021-06-06 17:14:56','2021-05-30 17:26:59','未逾期',NULL),
(139,123,NULL,'2021-05-30 17:24:31','2021-06-06 17:24:31',NULL,NULL,NULL),
(140,123,NULL,'2021-05-30 17:26:48','2021-06-06 17:26:48',NULL,NULL,NULL);
...
CREATE TABLE `borrow_card` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1805010221 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;

/*Data for the table `borrow_card` */

insert  into `borrow_card`(`id`,`password`,`reader`,`rule_id`,`status`,`username`,`header`,`describe`,`cellphone`,`email`,`sex`) values 
(1,'root','老王',7,1,'123','/header/cac3af13-42b3-46f7-8283-d2a5875cf507.jpg','活泼开朗、乐观向上、兴趣广泛、适应力强、上手快、勤奋好学、脚踏实地、认真负责、坚毅不拔、吃苦耐劳、勇于迎接新挑战。\r\n										','15251711139','123@niit.edu.cn',0),
(2,'root','黄白白',2,0,'1805010203',NULL,NULL,NULL,NULL,NULL),
(3,'root','黄土',1,1,'1805010204',NULL,NULL,NULL,NULL,NULL),
(4,'1234','白云',1,1,'1805010205',NULL,NULL,NULL,NULL,NULL),
(5,'111','月',6,1,'1805010206',NULL,NULL,NULL,NULL,NULL),
(6,'admin','明月',1,1,'1805010207',NULL,NULL,NULL,NULL,NULL),
(7,'admin','明月复苏',1,1,'1805010208',NULL,NULL,NULL,NULL,NULL),
(8,'yue','张沙',1,1,'1805010210',NULL,NULL,NULL,NULL,NULL),
(9,'mingming','星星',1,1,'1805010211',NULL,NULL,NULL,NULL,NULL),
(10,'admin','明月',1,1,'1805010212',NULL,NULL,NULL,NULL,NULL),
(11,'chen','辰',1,1,'1805010213',NULL,NULL,NULL,NULL,NULL),
(12,'1234','小红',1,1,'1805010214',NULL,NULL,NULL,NULL,NULL),
(13,'赵雪','赵雪',2,1,'1805010217',NULL,NULL,NULL,NULL,NULL),
(14,'1234','测试',1,0,'1805010219',NULL,NULL,NULL,NULL,NULL),
(1805010219,'456',NULL,NULL,NULL,'456',NULL,NULL,NULL,NULL,NULL),
(1805010220,'123',NULL,NULL,NULL,'wang',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `favorite_books` (
  ...
  CONSTRAINT `fk_bookid` FOREIGN KEY (`bookid`) REFERENCES `books` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `favorite_books` */

insert  into `favorite_books`(`id`,`bookid`,`cardid`) values 
(49,5,123),
(54,3,123),
(55,4,123);
